...
export default function Monitor() {
  const { runs, activeId, setActiveId, openLogs, toggleLog, agentEvents, mFilter, setMFilter, aiCache, setCacheItem } = useStore();
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
              <div>
                ...
                <div style={{ fontSize: 12, color: 'var(--text2)', marginTop: 4 }}>
                  {run.cluster} · {run.env} · {CATS.find(c => false)?.label || run.location} · Started {timeAgo(run.startedAt)}
                </div>
              </div>
